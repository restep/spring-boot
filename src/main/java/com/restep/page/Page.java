package com.restep.page;

import com.restep.req.PageReq;
...
public class Page<E> implements Serializable {
    ...
    public Page(PageReq pageReq, long totalNumber, List<E> list){
        super();
        this.currentPage = pageReq.getCurrentPage();
        this.totalNumber = totalNumber;
        this.list = list;
        this.totalPage = totalNumber % pageReq.getPageSize() == 0 ? totalNumber
                / pageReq.getPageSize() : totalNumber / pageReq.getPageSize() + 1;
    }
